        ...
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-8">
              PABSON Cricket League U-15 isn't just about cricket; it's about character.
              Organized by Kathmandu PABSON in collaboration with the National Sports Council,
              this tournament provides a professional platform for student-athletes to shine.
            </p>

            <div className="grid grid-cols-2 gap-6">
              {[
                { icon: Shield, title: "Integrity", desc: "Fair play above all" },
                { icon: Star, title: "Excellence", desc: "Pushing limits" },
                { icon: Award, title: "Recognition", desc: "National pathways" },
